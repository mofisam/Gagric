                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card product-card h-100 border-0 shadow-sm">
                            <div class="position-relative">
                                <a href="buyer/products/product-details.php?id=<?php echo $product['id']; ?>">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="product-title mb-2">
                                    <a href="buyer/products/product-details.php?id=<?php echo $product['id']; ?>" class="text-dark text-decoration-none">
    ...
    .then(data => {
        if (data.success) {
            if (data.action === 'added') {
                ...
                showErrorToast('Added to wishlist!'); // Using error toast for general notifications
            } else {
